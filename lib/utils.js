...
import { HandCoins, School, School2 } from "lucide-react"
...
export const sidebarLinks = [
  ...
  },
  {
    ...
    iconOn: <i class="bi bi-paperclip"></i>,
  },
  {
    name: "Employés",
    href: "/employees",
  ...
  },
  {
    ...
    iconOn: <i className="bi bi-journal-bookmark-fill"></i>,
  },
  {
    name: "Présence",
    href: "/attendance",
  ...
  },
  {
    ...
    iconOn: <i class="bi bi-people-fill"></i>,
  },
];
...
export function getRoleLabel(role) {
  ...
  return roles[role] || "Rôle inconnu";
}


export const UserPic = () => {
  return "https://i.pinimg.com/736x/1a/81/7a/1a817a95a42d8c43031378d122a05ffe.jpg"
};



export const isLocalFun = () => { return false; }

export const ServiceICON = ({ ...props }) => <HandCoins {...props} />

export const DivisionICON = ({ ...props }) => <i className="bi bi-buildings" {...props} ></i>
